...
cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
game_cont=input("Do you want to play the game of BLACKJACK? Type 'y' or 'n'. ").lower()
while(game_cont=='y'):
  clear()
  print(logo)
  user_cards=[]
  ...
  while(comp_score<=17):
    ...
    if(comp_cards[n]==11 and comp_score+comp_cards[n]>21):
      comp_score+=1
    else:
  ...
  print(f"Computer's final hand is {comp_cards}, final score is {comp_score}.")
  if(user_diff==0 and len(user_cards)==2):
    print("You win with a BlackJack")
  elif(comp_diff==0 and len(comp_cards)==2):
